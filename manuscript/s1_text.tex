...
\large Code Geometry, Enforcement Activation, and Exit Closure\\in Codified Moral Systems: An Agent-Based Model}
\author{}
\date{}
...
\midrule
Lagged punishment received & $7.96\times10^{-19}$ & [VERIFY] & 0.188 \\
Lagged punishment delivered & $5.17\times10^{-20}$ & [VERIFY] & 0.604 \\
Enforcer status & $-4.83\times10^{-19}$ & [VERIFY] & 0.434 \\
\bottomrule
\end{tabular}
\end{table}

[VERIFY: standard errors for the three coefficients in Table~S5.4. The source
results tables record coefficients and $p$-values only.]
