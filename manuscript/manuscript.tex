...
Institutional delegation is the mechanism that concentrates enforcement in a minority. At fixed intervals, the model selects an enforcement cadre of size $q = \lfloor \text{enforcer\_quota\_frac} \times N_{\text{active}} \rfloor$, where $\text{enforcer\_quota\_frac} = 0.08$ (8\% of the active population). Agents are ranked by a suitability score:
\[
