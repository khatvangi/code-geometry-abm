...
% -- figures --
\usepackage{graphicx}
% numeric option: bibliography is a manual thebibliography with plain \bibitem
...
\end{equation}
where \(E_t/P_t\) is the enforcer share of punishment events in that step. This equation defines a specification check: it is circular by construction because an outcome of the enforcement architecture directly determines outside-option degradation. In the independent-input specification,
\begin{equation}
...
The specified implementation is written in Python using Mesa, NumPy, pandas, and NetworkX. Run-level outputs and aggregated CSVs are committed at the paths named above. The canonical classifier in \texttt{src/regime\_classifier.py} is the single source of truth for discrete outcomes. All reported regimes are computed from continuous \texttt{final\_exit\_rate} and \texttt{max\_punish}; stored regime columns are non-authoritative because they do not necessarily implement the hierarchical criterion. This provenance rule separates immutable simulation outputs from reproducible analytical classification.
...
Exit foreclosure arises through either external imposition, characterized by the dose-response above, or internal absorption and generational replacement. An extension of the same model family represents the internal channel by updating exit capacity from outside-tie stocks, economic independence, tenure, and generic membership benefit. In the closure sweep, mean final capacity declines from 0.9302 at tenure crowd-out 0.0005 to 0.8392 at 0.002 and 0.5166 at 0.008; mean exit over the last 100 steps rises from 0.0415 to 0.0544 and 0.0685, respectively. Capacity settles at an interior equilibrium when outside-contact renewal exceeds institutional absorption; when institutional absorption exceeds renewal, the affected capacity channel converges to zero.
...
A specification in which outside-option closure is driven by the enforcer share yields capture by construction, because that quantity mechanically drives retention, one of the two capture criteria; exit capacity is therefore treated as an independent structural input. Enforcer share is not itself a criterion under the final classifier, in which capture is retained and active. When closure is decoupled from enforcer share, capture does not occur at any coupling strength: 0 of 4050 runs at each of $\kappa=1.5$, $3.0$, and $6.0$ (Figure~\ref{fig:circularity}).
...
\bibitem{bermanlaitin2008}
Berman E, Laitin DD.
Religion, terrorism and public goods: Testing the club model.
\textit{Journal of Public Economics}. 2008;92(10--11):1942--1967.
% recovered from repo source; duplicate of berman2008

\bibitem[Bok(2025)]{bok2025}
Bok J.
Religious exit costs.
\textit{Journal for the Scientific Study of Religion}. 2025;64(2):227--239. doi:10.1111/jssr.12963.
...
\bibitem{boydgintisbowles2010}
NEEDS VERIFICATION: Boyd, Gintis and Bowles, evolutionary model of how sanctioning spreads or persists.
[Placeholder: bibliographic details unverified. Do not submit with this entry.]
...
NEEDS VERIFICATION: Carvalho, review of the economics of religion.
[Placeholder: bibliographic details unverified. Do not submit with this entry.]
...
\bibitem{fehrgachter2000}
NEEDS VERIFICATION: Fehr and Gachter, experimental evidence that punishment sustains cooperation.
[Placeholder: bibliographic details unverified. Do not submit with this entry.]
...
\bibitem{gorelemosshultswildman2018}
NEEDS VERIFICATION: Gore, Lemos, Shults and Wildman, computational work linking cognition, culture, and social dynamics.
[Placeholder: bibliographic details unverified. Do not submit with this entry.]
...
\bibitem{hauertetal2007}
NEEDS VERIFICATION: Hauert et al., evolutionary model of punishment under specified population and institutional conditions.
[Placeholder: bibliographic details unverified. Do not submit with this entry.]

\bibitem{iannaccone1988}
NEEDS VERIFICATION: Iannaccone club-goods model of religious strictness; costly requirements screen out low-commitment members.
[Placeholder: bibliographic details unverified. Do not submit with this entry.]
...
\bibitem{iannacconemakowsky2007}
NEEDS VERIFICATION: Iannaccone and Makowsky, agent-based analysis in the economics of religion.
[Placeholder: bibliographic details unverified. Do not submit with this entry.]

\bibitem{iyer2016}
NEEDS VERIFICATION: Iyer, review of the economics of religion.
[Placeholder: bibliographic details unverified. Do not submit with this entry.]
...
\bibitem{mcbride2007}
NEEDS VERIFICATION: McBride, monitoring institutions sustaining religious production.
[Placeholder: bibliographic details unverified. Do not submit with this entry.]
...
\bibitem{wildmansosis2011}
NEEDS VERIFICATION: Wildman and Sosis, formal argument for bringing simulation into the study of religion.
[Placeholder: bibliographic details unverified. Do not submit with this entry.]
