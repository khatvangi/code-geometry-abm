...
concepts; initialisation; input data; submodels. A parameter-observable mapping
follows the entity specification and connects model inputs to institutional
features. Two further subsections, experimental design and reproducibility,
follow the protocol proper and describe the simulation experiments run on the
model and the provenance of their outputs.
