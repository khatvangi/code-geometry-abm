...
class Person(Agent):
    ...
    def maybe_exit(self):
        ...
        delta = float(np.clip(p.delta_outside_degrade, 0.0, 1.0))
        if delta <= 0.0:
        ...
        exit_drive = (p.exit_threshold - self.u) + punish_exit_term - punish_retention_term - 0.02 * deg
...
class ReligionABM(Model):
    ...
    def metrics(self) -> Dict[str, Any]:
        ...
        return dict(
            ...
            # v2.6.1: denominator restricted to active (non-exited) agents
